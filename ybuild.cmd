...
set ddd=2020.1.1
set iii=20.1.1.100
@echo %0 :: msbuild will get DisplayVersion  = %ddd%
@echo %0 :: msbuild will get InternalVersion = %iii%
@echo.

call "%ProgramFiles(x86)%"\MSBuild\14.0\Bin\msbuild.exe msbuild.proj /nologo /t:wix /p:TargetPlatform=amd64 /p:DisplayVersion=%ddd% /p:InternalVersion=%iii%
